...
import { ContainerAmqpController } from './container.amqp.controller';
import { ContainerService } from '../../service/container.service';
import { ErrorDto } from '../../../../dto/error.dto';

// TODO-MP: are these tests really necessary?
describe('ContainerAmqpController', () => {
  let controller: ContainerAmqpController;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [ContainerAmqpController],
    }).compile();

    controller = module.get<ContainerAmqpController>(ContainerAmqpController);
  });
  ...
  it('should get the name of this container', (done) => {
    controller.getName().subscribe((res) => {
      expect(res).toEqual(OUTPUT_GET_NAME_RESPONSE);
      done();
    });
  });
  ...
  it('should contain a specific segment', (done) => {
    controller.isSegmentInContainer({ segment: INPUT_SEGMENT_ADDRESS }).subscribe((res) => {
