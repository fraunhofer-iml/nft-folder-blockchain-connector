    ...
    inputs: [
      {
        indexed: false,
        internalType: 'string',
        name: 'oldAdditionalInformation',
        type: 'string',
      },
      {
        indexed: false,
        internalType: 'string',
        name: 'newAdditionalInformation',
        type: 'string',
      },
      {
        indexed: true,
